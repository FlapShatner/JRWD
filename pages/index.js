   ...
   <div className='wrapper'>
    <Head>
     ...
     <meta
      ...
      content='Jordan Roberts, full stack web developer specializing in React'
     />
     <meta
      property='og:image'
      content='https://i.postimg.cc/yNFbH1zg/og-portfolio.png'
     />
     <meta
      property='og:url'
      content='https://www.jrobertsweb.dev/'
     />
     <meta
      name='twitter:card'
